...
export class UpdateProcessorDTO {
  ...
  @Matches(/^[A-Za-z0-9ÁÉÍÓÚáéíóúÑñ\s\-]+$/, {
    message:
      'Marca del procesador inválida, solo letras, números, espacios y guiones',
  })
  brand?: string;
  ...
  @Matches(/^[A-Za-z0-9ÁÉÍÓÚáéíóúÑñ\s\-]+$/, {
    message:
      'Familia del procesador inválida, solo letras, números, espacios y guiones',
  })
  family?: string;
  ...
  @Matches(/^[A-Za-z0-9ÁÉÍÓÚáéíóúÑñ\s\-]+$/, {
    message:
      'Modelo del procesador inválido, solo letras, números, espacios y guiones',
  })
  model?: string;
